...
foreach ($rows as $feed) {
	...
	//echo "Scott!!!!!!!!! \n";
    echo "Scott " . $content->get_image_url() . "Scott";
	echo "</div>\n";
        ...
        if (count($itemrows) == 0) {
            ...
            if ($item->get_title() == NULL) {
                ...
                $insertquery =
                    ...
                    $insertquery =
                        "INSERT INTO items (id,feedTitle,feedLink,itemPubDate,itemLink,itemDesc, image_url) VALUES (" .
                        $feed['id'] . ",'" .
                        $item->get_feed()->get_title() .
                        "','" .
                        $item->get_feed()->get_permalink() .
                        ...
                        $item->get_permalink() .
                        "','" .
                        RemoveLinks($item->get_description()) . "', '\"Scott\"')";
                }
            }
            else {
                if(NULL != NULL) {
                    ...
                    $insertquery =
                        "INSERT INTO items (id,feedTitle,feedLink,itemTitle,itemPubDate,itemLink,itemDesc, image_url) VALUES (" .
                        $feed['id'] . ",'" .
                        $item->get_feed()->get_title() .
                        "','" .
                        $item->get_feed()->get_permalink() .
